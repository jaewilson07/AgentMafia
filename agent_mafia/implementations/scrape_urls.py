...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/implementations/scrape_urls.ipynb.

# %% auto 0
__all__ = ['process_chunk', 'read_url', 'process_url', 'process_rgd', 'process_urls']

# %% ../../nbs/implementations/scrape_urls.ipynb 2
import os
