...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/classes/Crawler_ProcessedChunk.ipynb.

# %% auto 0
__all__ = ['Crawler_ProcessedChunk_Metadata', 'PC_PathNotExist', 'Crawler_ProcessedChunk']

# %% ../../nbs/classes/Crawler_ProcessedChunk.ipynb 2
...
# %% ../../nbs/classes/Crawler_ProcessedChunk.ipynb 3
@dataclass
...
# %% ../../nbs/classes/Crawler_ProcessedChunk.ipynb 4
class PC_PathNotExist(Exception):
    def __init__(self, md_path):
        super().__init__(f"path {md_path} does not exist")

# %% ../../nbs/classes/Crawler_ProcessedChunk.ipynb 5
@dataclass
