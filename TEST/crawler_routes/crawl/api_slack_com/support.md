...
updated_dt: 2025-03-27T00:24:17.156858
---
[](https://api.slack.com/)
...
Whether you’re working on an app for the [Slack Marketplace](https://api.slack.com/slack-marketplace), developing your own [workflow-based app](https://api.slack.com/automation), or setting up a no-code solution with [Workflow Builder](https://api.slack.com/workflows), you'll find yourself in good company, from all of us here at Slack and the wider community of developers working with the platform.
## Slack Platform Support [](https://api.slack.com/support#platform-support)[](https://api.slack.com/support#platform-support)
Our [FAQ](https://api.slack.com/faq) answers many common questions about using our APIs. If you can't find your answer there, you can reach our dedicated Developer Support team at feedback@slack.com or through our [handy support system](https://my.slack.com/help/requests/new).
If you have questions about our Slack [tools](https://api.slack.com/tools) and SDKs, you'll want to check out the [Slack API GitHub org](https://github.com/slackapi). Our Developer Relations team actively responds to bug reports and enhancement suggestions related to these topics here. If your question falls outside of this, please use our [support system](https://my.slack.com/help/requests/new).
[Browse our FAQ](https://api.slack.com/faq) [Contact us](https://my.slack.com/help/requests/new)
## Stay informed [](https://api.slack.com/support#stay-informed)[](https://api.slack.com/support#stay-informed)
Find new features, breaking changes, and best practices in our [changelog](https://api.slack.com/changelog) and on the [Slack Developer Blog](https://slack.com/blog/developers).
...
[Read our blog](https://slack.com/blog/developers) [Follow our changelog](https://api.slack.com/changelog)
## Community discussions [](https://api.slack.com/support#community-discussions)[](https://api.slack.com/support#community-discussions)
...
## Contributions from developers like you [](https://api.slack.com/support#developer-contributions)[](https://api.slack.com/support#developer-contributions)
Find open source libraries, plugins, applications, and bots in our library of [Community Contributions](https://api.slack.com/community). We highlight a few libraries that are in active development and commonly observed in the wild.
## Subscribe to our developer newsletter [](https://api.slack.com/support#developer-newsletter)[](https://api.slack.com/support#developer-newsletter)
...
## On this page
[Slack Platform Support](https://api.slack.com/support#platform-support)
[Stay informed](https://api.slack.com/support#stay-informed)
[Community discussions](https://api.slack.com/support#community-discussions)
[Contributions from developers like you](https://api.slack.com/support#developer-contributions)
[Subscribe to our developer newsletter](https://api.slack.com/support#developer-newsletter)
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/support)
