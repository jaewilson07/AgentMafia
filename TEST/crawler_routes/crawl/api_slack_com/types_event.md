---
url: https://api.slack.com/types/event
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:15.409533
---
[](https://api.slack.com/)
...
We package all [event types](https://api.slack.com/events/api) delivered over the [Events API](https://api.slack.com/events-api) in a common JSON-formatted event wrapper.
```
{
    "token": "XXYYZZ",
    "team_id": "TXXXXXXXX",
...
### JSON schema
All delivered events follow this liberal [JSON Schema](http://json-schema.org/) specification. Documentation on [event types](https://api.slack.com/events/api) and our [Events API spec](https://github.com/slackapi/slack-api-specs) provide detail on specific event types.
```
{
...
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/types/event)
