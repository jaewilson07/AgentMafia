---
url: https://api.slack.com/developer-beta
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:17.741105
---
[](https://api.slack.com/)
...
As beta features may change, be careful about where you deploy apps using them. Additionally, to avoid any unintended user experiences, apps using these features **may not be submitted to the Slack Marketplace**.
**Beta feedback**
As you tinker with beta features, our engineering teams would love to hear what you think and how we can improve these features. [**Provide feedback**](https://docs.google.com/forms/d/e/1FAIpQLSc-lo2-_5EnEVNcmt1TH-vcg_zCMvIdxf1OIqK6lN3MlS1eHA/viewform)
## Current features[](https://api.slack.com/developer-beta#developer-beta-features__current-features)
We are not running any open beta programs at this time.
## Enabling beta features[](https://api.slack.com/developer-beta#developer-beta-features__enabling-beta-features)
To enable beta features, navigate to your app settings and click **Beta Features** on the sidebar. You can toggle on a per-feature basis. You should only enable beta features on non-production apps.
**Try it out by creating an app**[View configuration](https://api.slack.com/apps/new)
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/developer-beta)
