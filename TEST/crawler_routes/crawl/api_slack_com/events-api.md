...
### Choosing event subscriptions [](https://api.slack.com/events-api#event-subscriptions)[](https://api.slack.com/apis/events-api#event-subscriptions)
...
[Rate limiting](https://api.slack.com/events-api#rate-limiting)
