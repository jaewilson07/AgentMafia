---
url: https://api.slack.com/reference/block-kit
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:10.984830
---
[](https://api.slack.com/)
...
# Reference: Block Kit
[Block Kit](https://api.slack.com/block-kit) is made up of many atomic building blocks.
[**Blocks**](https://api.slack.com/reference/block-kit#blocks) are visual components that can be arranged to create app layouts. Apps can add blocks to _surfaces_ like [App Home](https://api.slack.com/surfaces/tabs), [messages](https://api.slack.com/surfaces/messages) and [modals](https://api.slack.com/surfaces/modals).
Blocks may also contain [**block elements**](https://api.slack.com/reference/block-kit#block-elements). Block elements are usually interactive components, such as buttons and menus.
Blocks and block elements are built with [**composition objects**](https://api.slack.com/reference/block-kit#composition-objects). Composition objects define text, options, or other interactive features within certain blocks and block elements.
## Blocks [](https://api.slack.com/reference/block-kit#blocks)[](https://api.slack.com/reference/block-kit#blocks)
Block | Description  
---|---  
[Actions block](https://api.slack.com/reference/block-kit/blocks#actions) | Holds multiple interactive elements.  
[Context block](https://api.slack.com/reference/block-kit/blocks#context) | Provides contextual info, which can include both images and text.  
[Divider block](https://api.slack.com/reference/block-kit/blocks#divider) | Visually separates pieces of info inside of a message.  
[File block](https://api.slack.com/reference/block-kit/blocks#file) | Displays info about [remote files](https://api.slack.com/messaging/files#remote).  
[Header block](https://api.slack.com/reference/block-kit/blocks#header) | Displays a larger-sized text block.  
[Image block](https://api.slack.com/reference/block-kit/blocks#image) | Displays an image.  
[Input block](https://api.slack.com/reference/block-kit/blocks#input) | Collects information from users via block elements.  
[Rich text block](https://api.slack.com/reference/block-kit/blocks#rich_text) | Displays formated, structured representation of text.  
[Section block](https://api.slack.com/reference/block-kit/blocks#section) | Displays text, possibly alongside block elements.  
[Video block](https://api.slack.com/reference/block-kit/blocks#video) | Displays an embedded video player.  
## Block elements [](https://api.slack.com/reference/block-kit#block-elements)[](https://api.slack.com/reference/block-kit#block-elements)
Block element | Description  
---|---  
[Button element](https://api.slack.com/reference/block-kit/block-elements#button) | Allows users a direct path to performing basic actions.  
[Checkboxes element](https://api.slack.com/reference/block-kit/block-elements#checkboxes) | Allows users to choose multiple items from a list of options.  
[Date picker element](https://api.slack.com/reference/block-kit/block-elements#datepicker) | Allows users to select a date from a calendar style UI.  
[Datetime picker element](https://api.slack.com/reference/block-kit/block-elements#datetimepicker) | Allows users to select both a date and a time of day.  
[Email input element](https://api.slack.com/reference/block-kit/block-elements#email) | Allows user to enter an email into a single-line field.  
[Image element](https://api.slack.com/reference/block-kit/block-elements#image) | Displays an image as part of a larger block of content.  
[Multi-select menu element](https://api.slack.com/reference/block-kit/block-elements#multi_select) | Allows users to select multiple items from a list of options.  
[Number input element](https://api.slack.com/reference/block-kit/block-elements#email) | Allows user to enter a number into a single-line field.  
[Overflow menu element](https://api.slack.com/reference/block-kit/block-elements#overflow) | Allows users to press a button to view a list of options.  
[Plain-text input element](https://api.slack.com/reference/block-kit/block-elements#input) | Allows users to enter freeform text data into a single-line or multi-line field.  
[Radio buttons element](https://api.slack.com/reference/block-kit/block-elements#radio) | Allows users to choose one item from a list of possible options.  
[Rich text input element](https://api.slack.com/reference/block-kit/block-elements#rich_text_input) | Allows users to enter formatted text in a WYSIWYG composer, offering the same messaging writing experience as in Slack.  
[Select menu element](https://api.slack.com/reference/block-kit/block-elements#select) | Allows users to choose an option from a drop down menu.  
[Time picker element](https://api.slack.com/reference/block-kit/block-elements#timepicker) | Allows users to enter numerical data into a single-line field.  
[URL input element](https://api.slack.com/reference/block-kit/block-elements#url) | Allows user to enter a URL into a single-line field.  
[Workflow button element](https://api.slack.com/reference/block-kit/block-elements#workflow_button) | Allows users to run a link trigger with customizable inputs.  
## Composition objects [](https://api.slack.com/reference/block-kit#composition-objects)[](https://api.slack.com/reference/block-kit#composition-objects)
Composition object | Description  
---|---  
[Confirmation dialog object](https://api.slack.com/reference/block-kit/composition-objects#confirm) | Provides a dialog that adds a confirmation step to interactive elements.  
[Conversations filter object](https://api.slack.com/reference/block-kit/composition-objects#filter_conversations) | Provides a way to filter the list of options in conversation selector menus.  
[Dispatch action configuration object](https://api.slack.com/reference/block-kit/composition-objects#dispatch_action_config) | Defines when a plain-text input element will return a `block_actions` interaction payload.  
[Input parameter object](https://api.slack.com/reference/block-kit/composition-objects#input_parameter) | Defines an object containing information about an input parameter.  
[Option object](https://api.slack.com/reference/block-kit/composition-objects#option) | Represents a single item in a number of item selection elements.  
[Option group object](https://api.slack.com/reference/block-kit/composition-objects#option_group) | Used to group option objects in select menus.  
[Text object](https://api.slack.com/reference/block-kit/composition-objects#text) | Defines text for many different blocks and elements.  
[Trigger object](https://api.slack.com/reference/block-kit/composition-objects#trigger) | Defines an object containing trigger information.  
[Workflow object](https://api.slack.com/reference/block-kit/composition-objects#workflow) | Defines an object containing workflow information.  
[Slack file object](https://api.slack.com/reference/block-kit/composition-objects#slack_file) | Defines an object containing Slack file information to be used in an image block or image element.  
Recommended reading
  * [Building with Block Kit](https://api.slack.com/block-kit/building)
...
[Composition objects](https://api.slack.com/reference/block-kit#composition-objects)
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/reference/block-kit)
