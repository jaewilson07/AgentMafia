---
url: https://api.slack.com/events/workflow_step_deleted
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:15.002675
---
[](https://api.slack.com/)
...
The `workflow_step_deleted` event is sent when a [workflow](https://api.slack.com/workflows) that contains at least one [step powered by your app](https://api.slack.com/workflows/steps) removes one of those steps. The event is sent when the step is deleted, not when the workflow is subsequently published.
...
Subscribe to the [`workflow_deleted` event](https://api.slack.com/events/workflow_deleted) as well to know, instead, when a workflow containing a step powered by your app has been deleted entirely.
...
## On this page
[Facts](https://api.slack.com/events/workflow_step_deleted#facts)
[Additional information](https://api.slack.com/events/workflow_step_deleted#markdown)
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/events/workflow_step_deleted)
