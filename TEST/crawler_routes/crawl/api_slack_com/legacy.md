---
url: https://api.slack.com/legacy
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:06.656876
---
[](https://api.slack.com/)
...
Enjoy this bit of the past inside the present and **stay tuned to our[platform changelog](https://api.slack.com/changelog)** for the latest information on features like these.
_What happened to "workspace apps"?_ Workspace apps are both deprecated and retired and effectively, no longer exist. [Learn more about the retirement of workspace apps](https://api.slack.com/changelog/2021-03-workspace-apps-to-retire-in-august-2021).
![](https://a.slack-edge.com/12b32/img/api/legacy_hub_no_frame.png)
