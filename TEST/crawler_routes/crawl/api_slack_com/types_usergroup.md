---
url: https://api.slack.com/types/usergroup
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:16.091184
---
[](https://api.slack.com/)
...
`users` | array | Contains a list of [user object](https://api.slack.com/types/user) `id` values which belong to the user group. This parameter is included if the `include_users` option is enabled on some API endpoints.  
`user_count` | integer | Indicates the total number of users in a group.  
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/types/usergroup)
