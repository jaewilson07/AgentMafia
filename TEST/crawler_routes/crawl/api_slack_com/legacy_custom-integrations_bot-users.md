---
url: https://api.slack.com/legacy/custom-integrations/bot-users
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:07.655747
---
[](https://api.slack.com/)
...
You won't be able to create new legacy custom integration bot users or classic apps anymore after June 4, 2024. [Learn how](https://api.slack.com/changelog/2024-04-discontinuing-new-creation-of-classic-slack-apps-and-custom-bots) this may impact you and your team.
Because we strongly recommend you do not use legacy custom integrations anymore, we recommend reading our [Handling user interaction in your Slack apps guide](https://api.slack.com/interactivity/handling) instead. It will help you recreate any existing legacy bot functionality.
...
#### Legacy management [](https://api.slack.com/legacy/custom-integrations/bot-users#legacy-bot-manage)[](https://api.slack.com/legacy/custom-integrations/bot-users#legacy-bot-manage)
...
#### Additional limitations [](https://api.slack.com/legacy/custom-integrations/bot-users#additional-limitations)[](https://api.slack.com/legacy/custom-integrations/bot-users#additional-limitations)
While you can use legacy bots to post messages, they do not have access to [interactive messages features](https://api.slack.com/interactive-messages). To make your messages interactive, you'll need to build a [Slack app](https://api.slack.com/quickstart) instead.
#### API methods for legacy bots [](https://api.slack.com/legacy/custom-integrations/bot-users#legacy-methods)[](https://api.slack.com/legacy/custom-integrations/bot-users#legacy-methods)
...
[auth.revoke](https://api.slack.com/methods/auth.revoke)Revokes a token.| Revokes a token.  
...
## On this page
[Legacy management](https://api.slack.com/legacy/custom-integrations/bot-users#legacy-bot-manage)
[Additional limitations](https://api.slack.com/legacy/custom-integrations/bot-users#additional-limitations)
[API methods for legacy bots](https://api.slack.com/legacy/custom-integrations/bot-users#legacy-methods)
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/legacy/custom-integrations/bot-users)
