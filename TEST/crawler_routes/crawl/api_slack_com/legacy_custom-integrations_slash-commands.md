---
url: https://api.slack.com/legacy/custom-integrations/slash-commands
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:07.865079
---
[](https://api.slack.com/)
...
Because we strongly recommend you do not use legacy custom integrations anymore, you should instead use the similar feature in [Slack apps](https://api.slack.com/slack-apps). Our [guide to Getting Started with Slash Commands](https://api.slack.com/slash-commands) will walk you through the process of enabling this functionality in a Slack app.
## Migrating from legacy Slash Commands [](https://api.slack.com/legacy/custom-integrations/slash-commands#migrating-from-legacy)[](https://api.slack.com/legacy/custom-integrations/slash-commands#migrating-from-legacy)
If you previously created any commands using legacy integrations, you should switch to using the same functionality with a [Slack app](https://api.slack.com/slack-app) instead. To do this you need to follow the [Getting Started with Slash Commands guide](https://api.slack.com/slash-commands) and create new commands to replicate your existing ones.
...
## Legacy information [](https://api.slack.com/legacy/custom-integrations/slash-commands#legacy-info)[](https://api.slack.com/legacy/custom-integrations/slash-commands#legacy-info)
...
#### Legacy management [](https://api.slack.com/legacy/custom-integrations/slash-commands#legacy-bot-manage)[](https://api.slack.com/legacy/custom-integrations/slash-commands#legacy-bot-manage)
...
#### Additional limitations [](https://api.slack.com/legacy/custom-integrations/slash-commands#additional-limitations)[](https://api.slack.com/legacy/custom-integrations/slash-commands#additional-limitations)
While you can respond to legacy Slash Commands to post messages in the same way as Slack Apps can, legacy integrations do not have access to [interactive messages features](https://api.slack.com/interactive-messages). To make your messages interactive, you'll need to [create a Slash Command with a Slack app](https://api.slack.com/slash-commands) instead.
## On this page
[Migrating from legacy Slash Commands](https://api.slack.com/legacy/custom-integrations/slash-commands#migrating-from-legacy)
[Legacy information](https://api.slack.com/legacy/custom-integrations/slash-commands#legacy-info)
[Legacy management](https://api.slack.com/legacy/custom-integrations/slash-commands#legacy-bot-manage)
[Additional limitations](https://api.slack.com/legacy/custom-integrations/slash-commands#additional-limitations)
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/legacy/custom-integrations/slash-commands)
