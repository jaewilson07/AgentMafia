...
updated_dt: 2025-03-27T00:24:11.576055
---
[](https://api.slack.com/)
...
![](https://api.slack.com/img/api/bolt/bolt-logo.svg)
## Choose your flavor
![](https://api.slack.com/img/api/bolt/bolt-js-logo.svg)
### [Bolt for JavaScript](https://api.slack.com/start/building/bolt-js)
A Node-based framework with TypeScript bindings.
[Get started](https://api.slack.com/start/building/bolt-js)
![](https://api.slack.com/img/api/bolt/bolt-py-logo.svg)
### [Bolt for Python](https://api.slack.com/start/building/bolt-python)
Built-in support for asynchronous request handling.
[Get started](https://api.slack.com/start/building/bolt-python)
![](https://api.slack.com/img/api/bolt/bolt-java-logo.svg)
### [Bolt for Java](https://api.slack.com/start/building/bolt-java)
Rapidly develop with Kotlin bindings and support for Servlet containers.
[Get started](https://api.slack.com/start/building/bolt-java)
## The basics of Bolt
### Effortless OAuth
...
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/bolt)
