---
url: https://api.slack.com/distribution/hosting
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:04.798411
---
[](https://api.slack.com/)
...
## Common cloud providers [](https://api.slack.com/distribution/hosting#cloud-providers)[](https://api.slack.com/distribution/hosting#cloud-providers)
### Heroku [](https://api.slack.com/distribution/hosting#heroku)[](https://api.slack.com/distribution/hosting#heroku)
...
✨ Follow our step-by-step guide on [deploying to Heroku](https://tools.slack.dev/bolt-js/deployments/heroku) using [Bolt for JavaScript](https://tools.slack.dev/bolt-js/concepts).
### AWS Lambda [](https://api.slack.com/distribution/hosting#aws)[](https://api.slack.com/distribution/hosting#aws)
[AWS Lambda](https://aws.amazon.com/lambda/) is a compute service that runs your code in response to events and automatically manages the compute resources, making it the fastest way to turn an idea into a modern, production, serverless application. Check out their respository for [running a Slackbot on AWS using coldbrew-cli](https://github.com/coldbrewcloud/tutorial-echo-slack-bot/blob/master/README.md).
✨ You can also follow our step-by-step guide on [deploying to AWS Lambda](https://slack.dev/bolt-js/deployments/aws-lambda) using [Bolt for JavaScript](https://slack.dev/bolt-js/concepts).
### Google Cloud Platform [](https://api.slack.com/distribution/hosting#google-cloud-platform)[](https://api.slack.com/distribution/hosting#google-cloud-platform)
...
### Microsoft Azure [](https://api.slack.com/distribution/hosting#ms-azure)[](https://api.slack.com/distribution/hosting#ms-azure)
...
### IBM Cloud [](https://api.slack.com/distribution/hosting#ibm-cloud)[](https://api.slack.com/distribution/hosting#ibm-cloud)
...
### Vercel [](https://api.slack.com/distribution/hosting#vercel)[](https://api.slack.com/distribution/hosting#vercel)
[Vercel's](https://vercel.com/docs) Frontend Cloud provides the developer experience and infrastructure to build, scale, and secure a faster, more personalized web. Check out their [Slack integration](https://vercel.com/integrations/slack).
## Next steps [](https://api.slack.com/distribution/hosting#next-steps)[](https://api.slack.com/distribution/hosting#next-steps)
▶️ **To list your app in the Slack Marketplace** , refer to our [Slack Marketplace review guide](https://api.slack.com/slack-marketplace/review-guide).
▶️ **To learn more about Slack app development** , check out [designing Slack apps](https://api.slack.com/design).
## On this page
[Common cloud providers](https://api.slack.com/distribution/hosting#cloud-providers)
[Heroku](https://api.slack.com/distribution/hosting#heroku)
[AWS Lambda](https://api.slack.com/distribution/hosting#aws)
[Google Cloud Platform](https://api.slack.com/distribution/hosting#google-cloud-platform)
[Microsoft Azure](https://api.slack.com/distribution/hosting#ms-azure)
[IBM Cloud](https://api.slack.com/distribution/hosting#ibm-cloud)
[Vercel](https://api.slack.com/distribution/hosting#vercel)
[Next steps](https://api.slack.com/distribution/hosting#next-steps)
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/distribution/hosting)
