...
updated_dt: 2025-03-27T00:24:01.539864
---
[](https://api.slack.com/)
...
## Permissions
### [Access tokens](https://api.slack.com/concepts/token-types)
...
### [Best practices for security](https://api.slack.com/authentication/best-practices)
...
### [Migration guide for classic apps](https://api.slack.com/authentication/migration)
Everything you need to know to migrate your classic app to use the new granular permissions model.
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/authentication)
