---
url: https://api.slack.com/apis/http
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:10.089527
---
[](https://api.slack.com/)
...
## Handling app installation and authentication with Request URLs [](https://api.slack.com/apis/http#request-urls)[](https://api.slack.com/apis/http#request-urls)
...
### Request URL configuration and verification [](https://api.slack.com/apis/http#verification)[](https://api.slack.com/apis/http#verification)
...
### URL verification handshake [](https://api.slack.com/apis/http#handshake)[](https://api.slack.com/apis/http#handshake)
...
### Respond to the challenge [](https://api.slack.com/apis/http#challenge)[](https://api.slack.com/apis/http#challenge)
...
## Next steps [](https://api.slack.com/apis/http#next-steps)[](https://api.slack.com/apis/http#next-steps)
...
## On this page
[Handling app installation and authentication with Request URLs](https://api.slack.com/apis/http#request-urls)
[Request URL configuration and verification](https://api.slack.com/apis/http#verification)
[URL verification handshake](https://api.slack.com/apis/http#handshake)
[Respond to the challenge](https://api.slack.com/apis/http#challenge)
[Next steps](https://api.slack.com/apis/http#next-steps)
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/apis/http)
