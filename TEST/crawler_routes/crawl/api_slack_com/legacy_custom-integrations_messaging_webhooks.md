---
url: https://api.slack.com/legacy/custom-integrations/messaging/webhooks
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:07.746848
---
[](https://api.slack.com/)
...
[Slack Engineering](https://api.slack.com/engineering)
[Community code of conduct](https://api.slack.com/community/code-of-conduct)
Using legacy custom integrations is an outdated way for teams to integrate with Slack. Legacy custom integrations lack newer features and will be deprecated and possibly removed in the future. **We do not recommend their use**. We recommend using their replacement: [Slack apps](https://api.slack.com/quickstart). Slack apps can be built [just for your own workspace](https://api.slack.com/start/distributing#single_workspace_apps) or [distributed through the Slack Marketplace](https://api.slack.com/slack-marketplace), and they can use the latest and greatest APIs and UI features. 
# Legacy custom integrations incoming webhooks
Incoming webhooks are an effecient way to post messages from apps into Slack.
## Migrating to app-based webhooks [](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#migrating-from-legacy)[](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#migrating-from-legacy)
If you previously created any incoming webhooks using legacy custom integrations, you should switch to using the same functionality with a [Slack app](https://api.slack.com/slack-apps) instead. To create new app-based webhooks or replicate your existing ones, follow our [Quickstart guide](https://api.slack.com/quickstart) or the more advanced [Getting started with incoming webhooks guide](https://api.slack.com/messaging/webhooks).
...
## Legacy information [](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#legacy-info)[](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#legacy-info)
Though we recommend that all legacy custom integrations should [migrate to Slack apps](https://api.slack.com/custom-integrations#migrating_to_apps), we also understand that some will still need to maintain older integrations. This section contains any information about using incoming webhooks that is specific to the legacy implementation.
#### Legacy management [](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#legacy-bot-manage)[](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#legacy-bot-manage)
...
#### Additional limitations [](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#additional-limitations)[](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#additional-limitations)
While you can use legacy incoming webhooks to post messages, they do not have access to [interactive messages features](https://api.slack.com/interactive-messages). To make your messages interactive, you'll need to [create an incoming webhook with a Slack app](https://api.slack.com/messaging/webhooks) instead.
**Please note:** it's not possible to send files via webhook. [The `files.upload` API method](https://api.slack.com/messaging/files#uploading_files) is the method of choice for this task.
#### Runtime customizations [](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#legacy-customizations)[](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#legacy-customizations)
...
## On this page
[Migrating to app-based webhooks](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#migrating-from-legacy)
[Legacy information](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#legacy-info)
[Legacy management](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#legacy-bot-manage)
[Additional limitations](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#additional-limitations)
[Runtime customizations](https://api.slack.com/legacy/custom-integrations/messaging/webhooks#legacy-customizations)
