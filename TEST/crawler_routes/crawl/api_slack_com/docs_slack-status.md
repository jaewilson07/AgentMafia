---
url: https://api.slack.com/docs/slack-status
session_id: slack_api_docs
updated_dt: 2025-03-27T00:24:18.691432
---
[](https://api.slack.com/)
...
## Atom and RSS Feed [](https://api.slack.com/docs/slack-status#feed)[](https://api.slack.com/apis/slack-status#feed)
...
## API reference [](https://api.slack.com/docs/slack-status#api)[](https://api.slack.com/apis/slack-status#api)
...
```
curl https://slack-status.com/api/v2.0.0/current
curl https://slack-status.com/api/v2.0.0/history

```

### Version 2.0.0 [](https://api.slack.com/docs/slack-status#v2_0_0)[](https://api.slack.com/apis/slack-status#v2_0_0)
#### Current Status API[](https://api.slack.com/docs/slack-status#v2_0_0__current-status-api)[](https://api.slack.com/apis/slack-status#v2_0_0__current-status-api)
...
#### History API[](https://api.slack.com/docs/slack-status#v2_0_0__history-api)[](https://api.slack.com/apis/slack-status#v2_0_0__history-api)
...
### Version 1.0.0 [](https://api.slack.com/docs/slack-status#v1_0_0)[](https://api.slack.com/apis/slack-status#v1_0_0)
...
## Best practices[](https://api.slack.com/docs/slack-status#best-practices)[](https://api.slack.com/apis/slack-status#best-practices)
...
## On this page
[Atom and RSS Feed](https://api.slack.com/docs/slack-status#feed)
[API reference](https://api.slack.com/docs/slack-status#api)
[Version 2.0.0](https://api.slack.com/docs/slack-status#v2_0_0)
[Version 1.0.0](https://api.slack.com/docs/slack-status#v1_0_0)
[Status](https://slack-status.com)[Policy](https://api.slack.com/developer-policy)[Terms](https://slack.com/intl/en-gb/terms-of-service/api-updated)[Your Privacy Choices](https://www.salesforce.com/form/other/privacy-request/ "Your Privacy Choices")[Cookie Preferences](https://api.slack.com/docs/slack-status)
